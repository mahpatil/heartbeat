# step-timeout Specification

## Purpose

Allow individual job steps to declare a maximum run duration. This prevents
runaway shell commands or hung agent subprocesses from blocking the scheduler
indefinitely, and gives operators deterministic failure semantics with `on_fail`
hook support.
